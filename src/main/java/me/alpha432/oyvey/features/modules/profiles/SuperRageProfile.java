...
public class SuperRageProfile extends Module {
    public SuperRageProfile() {
        super("Super-Rage", "GOD MODE ACTIVATED", Category.PROFILES, true, false, false);
    }
